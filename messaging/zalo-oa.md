...
- **Bước 1**: Click vào hình ![Icon ZNS](../assets/extracted_images/zbs_crm/image1.png) => Mẫu Email, SMS, ZNS để vào giao diện tạo template.
![Giao diện Mẫu SMS Email ZNS](../assets/extracted_images/zbs_crm/image2.png)

- **Bước 2**: Click vào hình sau đó click vào nút ![Icon Thêm](../assets/extracted_images/zbs_crm/image3.png) để tạo bản mẫu Zalo ZBS.
![Tạo bản mẫu Zalo ZBS](../assets/extracted_images/zbs_crm/image4.png)
...
![Cấu hình thông tin 1](../assets/extracted_images/zbs_crm/image5.png)
...
![Cấu hình thông tin 2](../assets/extracted_images/zbs_crm/image6.png)
...
![Cấu hình thông tin 3](../assets/extracted_images/zbs_crm/image7.png)
  - Kiểm tra lại một lượt nữa và nhấn nút ![Icon Lưu](../assets/extracted_images/zbs_crm/image10.png) để tạo template và đẩy lên Zalo.
...
![Cấu hình thanh toán OA](../assets/extracted_images/zbs_crm/image9.png)
...
![Giao diện danh sách duyệt](../assets/extracted_images/zbs_crm/image11.png)
![Giao diện danh sách từ chối](../assets/extracted_images/zbs_crm/image12.png)

{% hint style="danger" %}
* Lưu ý: Nếu template bị từ chối, vui lòng tạo lại template khác.
{% endhint %}
![Chi tiết mẫu từ chối](../assets/extracted_images/zbs_crm/image13.png)
![Tạo lại template](../assets/extracted_images/zbs_crm/image14.png)
