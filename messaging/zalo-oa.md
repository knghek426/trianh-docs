...
* **Bước 3**: Điền các thông tin cần thiết như:
  ...
  *   Chọn mục đích gửi ZBS.
      ...
      ![Khai báo nội dung ZBS](<../.gitbook/assets/image6 (9).png>)
  ...
  *   Nhập văn bản ( Nếu tiêu đề có biến, biến phải để trong dấu `{}` và nhập tối thiểu 1 ô văn bản).
      ...
      ![Khai báo Hình ảnh, Tiêu đề, Văn bản](<../.gitbook/assets/image7 (8).png>)
  ...
  *   Mã tracking là mã tự sinh.
      ...
      ![Khai báo Bảng và Tham số](<../.gitbook/assets/image9 (5).png>)
...
*   **Bước 3**: Click chọn Loại ZBS Yêu cầu thanh toán => Thêm hình ảnh logo, tiêu đề văn bản như Mẫu Tùy Chỉnh.
    ...
    ![Chọn Loại ZBS Thanh toán](<../.gitbook/assets/image11 (6).png>)
    ...
    * Cập nhật thông tin thanh toán Zalo OA.
    ...
    ![Điền Thông tin thanh toán](<../.gitbook/assets/image12 (8).png>)
    ...
    *   Mã tracking là mã tự sinh.
        ...
        ![Điền Bảng, Tham số mẫu Thanh toán](<../.gitbook/assets/image13 (7).png>)
    * Kiểm tra lại một lượt nữa và nhấn nút **Tạo** hoặc **Lưu** để tạo template và đẩy lên Zalo.
*   Màn hình giao diện template được duyệt và từ chối như sau:

    ![Trạng thái template](<../.gitbook/assets/image14 (7).png>)
