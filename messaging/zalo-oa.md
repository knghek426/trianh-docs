...
* **Bước 1**: Click vào hình ![Icon Cài đặt](<../.gitbook/assets/image1 (7).png>) => Mẫu Email, SMS, ZNS để vào giao diện tạo template. ![Giao diện Mẫu SMS Email ZNS](<../.gitbook/assets/image2 (7).png>)
...
* **Bước 3**: Điền các thông tin cần thiết như:
  ...
  * Chọn loại ZBS.
  * Chọn mục đích gửi ZBS. ![Khai báo nội dung ZBS](<../.gitbook/assets/image5 (7).png>)
  ...
  * Nhập văn bản ( Nếu tiêu đề có biến, biến phải để trong dấu `{}` và nhập tối thiểu 1 ô văn bản). ![Khai báo Hình ảnh, Tiêu đề, Văn bản](<../.gitbook/assets/image6 (6).png>)
  ...
  * Mã tracking là mã tự sinh. ![Khai báo Bảng và Tham số](<../.gitbook/assets/image9 (4).png>)
...
* **Bước 2**: Click vào hình ![Icon Mở rộng](<../.gitbook/assets/image3 (6).png>) sau đó click vào nút ![Icon Thêm thẻ ZBS](<../.gitbook/assets/image4 (6).png>) để tạo bản mẫu Zalo ZBS.
*   **Bước 3**: Click chọn Loại ZBS Yêu cầu thanh toán => Thêm hình ảnh logo, tiêu đề văn bản như Mẫu Tùy Chỉnh. ![Chọn Loại ZBS Thanh toán](<../.gitbook/assets/image11 (5).png>)
    ...
    * Ghi chú cho kiểm duyệt có thể điền nội dung bất kì. Ví dụ: Template này dùng để giao dịch.
    * Mã tracking là mã tự sinh. ![Điền Bảng, Tham số mẫu Thanh toán](<../.gitbook/assets/image13 (4).png>)
    * Kiểm tra lại một lượt nữa và nhấn nút ![Icon Tạo](<../.gitbook/assets/image10 (4).png>) để tạo template và đẩy lên Zalo.
* Màn hình giao diện template được duyệt và từ chối như sau: ![Trạng thái template](<../.gitbook/assets/image14 (4).png>)
