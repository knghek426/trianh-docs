...
* **Bước 1**: Click vào **Quản lý** -> **Cài đặt** -> **Mẫu Email & SMS** -> **Mẫu tin Gateway** ![Truy cập Mẫu tin Gateway](<../.gitbook/assets/image12 (4).png>)
* **Bước 2**: Click vào hình dấu ![Icon Thêm](<../.gitbook/assets/image13 (3).png>) hoặc ![Nút tạo Gateway](<../.gitbook/assets/image14 (3).png>) để thêm mới.
* **Bước 3**: Gồm những thông tin như ( Có thể tham khảo hình ở dưới):
  * **Tên mẫu tin**: Tên hiển thị bên ngoài
  * **Mẫu tin**: Lấy giá trị ở các mẫu tin có sẵn. (VD: template cskh mình đang tạo mẫu tin) ![Thông tin Gateway 1](<../.gitbook/assets/image15 (2).png>)
  * Chọn các biến để mapping với mẫu tin cskh. ![Thông tin Gateway 2](<../.gitbook/assets/image16 (2).png>)
  * Chọn gửi từ CSKH App. ![Thông tin Gateway 3](<../.gitbook/assets/image17 (2).png>)
* **Bước 4**: Sau khi thiết lập xong cấu hình gửi tin thì lưu cấu hình lại. ![Lưu Mẫu tin Gateway](<../.gitbook/assets/image18 (2).png>)

## 2. Tạo và gửi chiến dịch CSKH tại trang TCRM của đơn vị

* **Bước 1**: Click vào **Khách hàng** -> **Chiến dịch tự động** -> **Quản lý chiến dịch**. ![Truy cập Quản lý chiến dịch](<../.gitbook/assets/image19 (1).png>)
* **Bước 2**: Click vào nút dấu ![Icon Thêm chiến dịch](<../.gitbook/assets/image20 (1).png>) để tạo chiến dịch
* **Bước 3**: Có các thông tin cần chọn như sau:
  ...
  * ![Icon Upload](<../.gitbook/assets/image22 (2).png>) : Click vào đây để đẩy file lên.
  * Nhấn nút ![Icon Lưu](<../.gitbook/assets/image23 (2).png>) để bắt đầu tạo chiến dịch. ![Cấu hình tạo chiến dịch](<../.gitbook/assets/image21 (1).png>)
* **Bước 4**: Sau khi lưu xong, nhấn vào nút “play” để bắt đầu gửi chiến dịch. ![Nút Gửi chiến dịch](<../.gitbook/assets/image24 (2).png>) ![Gửi chiến dịch trực tiếp](<../.gitbook/assets/image25 (1).png>)
