# Hướng dẫn tạo Template & Chiến dịch Tự động
...
1. Nhấp chọn menu **Quản lý** > **Cài đặt**.
![Truy cập Cài đặt](../assets/extracted_images/chien_dich_cskh/image1.png)
2. Chọn **Chức năng mới** > **Danh sách mẫu tin**.
![Chọn Danh sách mẫu tin](../assets/extracted_images/chien_dich_cskh/image2.png)
3. Nhấp biểu tượng **Dấu cộng (+)** để thêm mẫu tin nhắn mới.
![Nút tạo Mẫu tin](../assets/extracted_images/chien_dich_cskh/image3.png)
...
5. Sau khi nhập thông tin, nhấn **Lưu** để khởi tạo Template.
![Điền thông số Mẫu tin](../assets/extracted_images/chien_dich_cskh/image4.png)
![Chi tiết Nội dung và Tổ chức](../assets/extracted_images/chien_dich_cskh/image5.png)
...
![Giao diện Ánh xạ biến Excel](../assets/extracted_images/chien_dich_cskh/image10.png)
5. Nhấn **Lưu (biểu tượng đĩa mềm)** để hoàn tất gán biến.
![Lưu cấu hình biến](../assets/extracted_images/chien_dich_cskh/image11.png)
...
![Chọn Mẫu tin Gateway](../assets/extracted_images/chien_dich_cskh/image12.png)
3. Nhấp biểu tượng **Dấu cộng (+)** để phân đoạn mẫu mới.
![Tạo mới Gateway](../assets/extracted_images/chien_dich_cskh/image13.png)
...
![Thông tin Mẫu tin Gateway](../assets/extracted_images/chien_dich_cskh/image14.png)
![Lưu Mẫu tin Gateway](../assets/extracted_images/chien_dich_cskh/image15.png)
...
![Truy cập Quản lý Chiến dịch](../assets/extracted_images/chien_dich_cskh/image16.png)
3. Nhấp biểu tượng **Dấu cộng (+)** để tạo dự án thông báo mới.
![Nút tạo chiến dịch mới](../assets/extracted_images/chien_dich_cskh/image17.png)
4. Tại Form tạo Chiến dịch, thực hiện:
   - **Loại:** Chọn **Gateway**.
   - **Biểu mẫu:** Chọn **Mẫu tin Gateway** bạn vừa thao tác ở Phần 2.
   - **Tải lên File dữ liệu:** Nhấp vào biểu tượng chức năng **Upload** để tải Data KH (File Excel) lên hệ thống. *(Nhấp nút `Download template` nếu cần lấy cấu trúc cột cơ bản để làm lại file Excel).*
5. Nhấp nút **Lưu** để chuyển chiến dịch sang trạng thái Sẵn sàng.
![Điền form Chiến dịch mới](../assets/extracted_images/chien_dich_cskh/image18.png)
![Nút Upload tải File dữ liệu](../assets/extracted_images/chien_dich_cskh/image22.png)
...
![Nút Play Kích hoạt chiến dịch](../assets/extracted_images/chien_dich_cskh/image24.png)
![Trạng thái Chiến dịch Đang chạy](../assets/extracted_images/chien_dich_cskh/image25.png) 
