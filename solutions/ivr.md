...
<h2 style="margin-top:0">🎙️ Dịch vụ IVR — Tương tác thoại tự động</h2>
<p><strong>IVR (Interactive Voice Response)</strong> là hệ thống trả lời điện thoại tự động, cho phép xây dựng kịch bản menu thoại tương tác: phát lời thoại, nhận phím bấm (DTMF), phân luồng cuộc gọi theo bộ phận/thời gian, thu thập dữ liệu và lưu thẳng vào CRM.</p>
...
<!-- TODO: Bổ sung hình ảnh giao diện thiết lập kịch bản IVR trên dashboard -->
<p><em>📸 [Hình ảnh giao diện thiết lập kịch bản IVR — sẽ bổ sung sau]</em></p>
...
[← Voice Brandname](../solutions/voice-brandname.md) &nbsp;|&nbsp; [Tổng quan TCRM →](../tcrm/overview.md)
